...
class MoveTokenFlow(private val origin: AccountInfo, private val destination: AccountInfo, val amount: Long) : FlowLogic<Unit>() {
    ...
    override fun call() {
        ...
        subFlow(MoveFungibleTokensFlow(partyAndAmount = PartyAndAmount(destinationParty, amount.EUR), participantSessions = allOtherParticipants.map { initiateFlow(it) }, changeHolder = originParty))
